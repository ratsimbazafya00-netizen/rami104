...
class Card:
    ...
    def from_dict(cls, data):
        """Reconstruit une carte depuis son dict `to_dict()` (utilisé pour
        recharger l'état d'une partie depuis le stockage persistant)."""
        return cls(data["rank"], data["suit"], data["copy_id"])
